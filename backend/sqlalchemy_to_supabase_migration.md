...
| `delete_character_backstory`                   | [x]     | Converted to Supabase query                                             |
| `get_chapter_count`                            | [x]     | Converted to Supabase query                                             |
| `create_event`                                 | [x]     | Converted to Supabase query                                             |
| `save_character_backstory`                     | [x]     | Converted to Supabase query                                             |
| `get_character_backstories`                    | [x]     | Converted to Supabase query                                             |
| `get_latest_unprocessed_chapter_content`       | [x]     | Converted to Supabase query                                             |
| `create_character_relationship`                | [x]     | Converted to Supabase query                                             |
| `update_event`                                 | [x]     | Converted to Supabase query                                             |
| `get_event_by_title`                           | [x]     | Converted to Supabase query                                             |
| `update_location`                              | [x]     | Converted to Supabase query                                             |
| `update_character_relationship`                | [x]     | Converted to Supabase query                                             |
